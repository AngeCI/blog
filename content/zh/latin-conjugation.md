...
- 變位法（conjugation class）：嚴格來說，許多動詞其實在現在時系統和完成時系統當中，分別有着兩套獨立的變位法系統。不過完成時系統的變位法不影響那一部份詞形的人稱詞尾，傳統上也就只關注現在時系統的變位法了。
...
# 動詞分類
拉丁語的動詞詞目通常有四個部份，展示了拉丁語動詞的四種詞幹。

拉丁語的動詞傳統上分為四種變位法，可從動詞的第二條目的結尾推斷：
...
和[名詞](/blog/zh/latin-nouns-declension/)一樣，動詞的第三變位法有兩個亞種，它們在第一條目的表現有點不一樣。

動詞的變位法只影響它在現在時系統怎麼變形，完成時系統的詞幹和詞形與變位法無關。
...
拉丁語的動詞變位法實際上是兩種系統的交織。大多數比較能產的第一和第二變位法動詞，是屬於一種較新的層次，完成詞幹是直接從現在詞幹推出來的。而第三變位法動詞的完成詞幹，則通常來自另一較古老的層次，詞幹構成方式多種多樣。下表顯示各種變位法的各種時態第一人稱單數主動形式：

|  | 1st (ā-stem) | 2nd (ē-stem) | 3rd (ĕ-stem) | 3rd (ĭ-stem) | 4th (ī-stem) |
| -- | -- | -- | -- | -- | -- |
| 現在時 | -ō | -eō | -ō | -iō | -iō |
| 不定式 | -āre | -ēre | -ere | -ere | -īre |
| 未完成時 | -ābam | -ēbam | -ēbam  | -iēbam  | -iēbam |
| 將來時 | -ābō | -ēbō | -am  | -iam  | -iam |
| 完成時 | -āvī | -uī | -ī | -ī | -īvī |
| 過去分詞 | -ātum | -itum | -tum | -tum | -ītum |
...
| 未完成時 | -ābam | -ēbam | -ēbam | -iēbam | -iēbam |
| 將來時 | -ābō | -ēbō | -am | -iam | -iam |
| 現在時被動 | -or | -eor | -or | -ior | -ior |
| 未完成時被動 | -ābar | -ēbar | -ēbar  | -iēbar  | -iēbar |
| 將來時被動 | -ābor | -ēbor | -ar | -iar | -iar |

|  | egō | tū | is, ea, id | nōs | vōs | eī, eae, ea |
| -- | -- | -- | -- | -- | -- | -- |
| 現在時 | -ō | -s | -t | -mus | -tis | -nt |
| 未完成時 | -bam | -bās | -bat | -bāmus | -bātis | -bant |
| 將來時（1, 2） | -bō | -bis | -bit | -bimus | -bitis | -bunt |
| 將來時（3, 4） | -am | -ēs | -et | -ēmus | -ētis | -ent |
| 現在時被動 | -or | -ris | -tur | -mur | -minī | -ntur |
| 未完成時被動 | -bar | -bāris | -bātur | -bāmur | -bāminī | -bantur |
...
|  | egō | tū | is, ea, id | nōs | vōs | eī, eae, ea |
| -- | -- | -- | -- | -- | -- | -- |
| 完成時 | -ī | -istī | -it | -imus | -istis | -ērunt |
| 過去完成時 | -eram | -erās | -erat | -erāmus | -erātis | -erant |
| 將來完成時 | -erō | -eris | -erit | -erimus | -eritis | -erint |

- 過去完成時的詞尾，其實就是 sum, esse 的未完成時變位；
- 將來完成時的詞尾，其實就是 sum, esse 的將來時變位，除了第三人數複數有點不一樣之外。
