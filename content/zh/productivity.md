...
- Discord 商業味太濃，而且還在為年齡驗證的事情炎上着呢。
...
# 一潭死水的自由軟體市場
> 「自由軟體要是連事都幹不了，那要它有何用？」——佚名

博弈的後果是，很多必要的軟體和服務，往往都達不到（所有條件皆）理想的狀況，哪怕現成的選擇其實不少。

Wiwi 就曾經有列出過一個[真·宅男指南](https://wiwi.blog/blog/fake-vs-real-tech-nerd/)。我是覺得他裏面的不少看法（至少在 2026 年當下）實在是有點太激進，一些項目實際上並不太現實，跟燒錢沒啥差別。預算不足的情況下甚至會構成對生產力的負累。
...
[^2]: <span class="chide">在寫這篇文章的時候去了查 Wiwi 的網站，發現他已經把「Firefox 是間諜軟體」的表述給靜悄悄移除了。</span>
