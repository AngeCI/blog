...
> [!WARNING] Notice
> 呢篇文章暫時仲未粵語化，暫時拎住[書面語版本](/blog/zh/personal-brand-domain/)頂住檔先。我遲啲有時間會更新返粵語版本！
...
另外如果你要考慮自架郵件伺服器的話，實際上電子郵件服務在很多年前就已經被大量的 spam mail 玩成了信任死鎖，自架郵件服務很難發信的。據說 `.com` 域名發出的郵件，而推出時代較晚的 `.win`、`.xyz` 之類的域名<span class="chide">由於比較常拿來做奇怪的事情，</span>比較容易被其他網站不信任。
